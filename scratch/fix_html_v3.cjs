...
const startIndex = html.indexOf('function loadMarkers() {');
const endIndex = html.indexOf('function clearAllData() {');
...
if (startIndex !== -1 && endIndex !== -1) {
  ...
  html = html.slice(0, startIndex) + newLoadMarkers + html.slice(endIndex);
