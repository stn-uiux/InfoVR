...
export const DevicePanel = () => {
      ...
      <div className="add-device-modal-overlay" onClick={closeAddModal}>
        <div className="add-device-modal" onClick={(e) => e.stopPropagation()}>
          ...
          <div className="comm-modal-header">
            <div>
              <h2 className="comm-modal-title">Add New Device</h2>
              <span
                style={{
                  fontSize: "var(--font-size-sm)",
                  color: "var(--text-secondary)",
            ...
            <button className="comm-modal-close" onClick={closeAddModal}>
              &times;
            </button>
          </div>
          ...
          <div className="comm-modal-content">
            ...
            <div className="stn-field">
              <label className="stn-label">등록 장비 선택</label>
  ...
  return (
    <div className="stn-side-panel" style={{ width: "400px" }}>
      <div className="stn-side-panel-header">
        <div>
          {isEditingName ? (
            <input
              ref={editInputRef}
      ...
      <div className="stn-side-panel-content">
        ...
        {isEditMode && (
          <div className="stn-section" style={{ marginBottom: "16px" }}>
            <h3 className="stn-section-title">Rack Orientation</h3>
            <div
              style={{
                display: "grid",
                gridTemplateColumns: "1fr 1fr",
            ...
            >
              {[
                ...
                return (
                  <button
                    key={dir.value}
                    className={`comm-btn comm-btn-sm ${isCurrentDirection ? "comm-btn-primary" : "comm-btn-secondary"}`}
                    onClick={() =>
                      !isDisabled &&
