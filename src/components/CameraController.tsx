    ...
    if (controls) {
      ...
      if (storeState.focusedRackId) {
        ...
        if (targetRack) {
          ...
          const currentIds = storeState.obstructingRackIds;
          if (currentIds.length !== obstructingIds.length || !currentIds.every((id, i) => id === obstructingIds[i])) {
            storeState.setObstructingRackIds(obstructingIds);
          }
        }
      }
    }
