...
export default function App() {
  ...
  useEffect(() => {
    ...
    const timeoutId = setTimeout(async () => {
      try {
        if (image) await localforage.setItem("port-sentinel-image", image);
        else await localforage.removeItem("port-sentinel-image");

        await localforage.setItem("port-sentinel-ports", ports);
        await localforage.setItem("port-sentinel-analysis", analysis);
      } catch (err) {
    ...
    <div className="sentinel-root">
      <header className="sentinel-header">
        <div className="sentinel-header__left">
          <button
            onClick={() => navigate("/")}
            className="sentinel-header__back-btn"
          ...
          <div>
            <h1 className="sentinel-header__title">
              포트맵핑 마법사 <Icon icon="mdi:magic" className="comm-icon-magic-lg" />
            </h1>
            <p className="sentinel-header__subtitle">
        ...
        <div className="sentinel-header__right">
          {image && (
            <>
              <div className="sentinel-toolbar__history">
                <button
                  onClick={undo}
                  disabled={past.length === 0}
                  className="sentinel-toolbar__history-btn"
                  title="실행 취소 (Ctrl+Z)"
                >
                  <Icon icon="lucide:undo-2" />
                </button>
                <div className="sentinel-toolbar__divider" />
                <button
                  onClick={redo}
              ...
              <button
                ...
                className="sentinel-toolbar__add-btn"
              >
              ...
              <button
                ...
                className={`sentinel-toolbar__edit-btn ${
                  editMode ? "sentinel-toolbar__edit-btn--active" : ""
                }`}
              >
                {editMode ? (
              ...
              <div className="sentinel-toolbar__divider--tall" />

              <div className="sentinel-toolbar__actions">
                <button
                  onClick={() => setShowDownloadModal(true)}
                  className="sentinel-toolbar__icon-btn"
                  title="SVG 내보내기"
                >
                ...
                <button
                  onClick={() => clearImage()}
                  className="sentinel-toolbar__icon-btn sentinel-toolbar__icon-btn--danger"
                  title="프로젝트 초기화"
                >
      ...
      <main className="sentinel-main">
        <div className="sentinel-layout">
          {/* Visual Mapping Area */}
          <section className="sentinel-canvas-section">
            <div className="sentinel-canvas-wrapper">
              {image && (
                <>
                  <div className="sentinel-crop-controls" style={{ position: 'absolute', top: '1rem', left: '1rem', zIndex: 500 }}>
                    {isCropping ? (
                      <div style={{ display: 'flex', gap: '8px' }}>
                        <button
                          onClick={() => setIsCropping(false)}
                          className="sentinel-zoom__fit-btn"
                  ...
                  <div className="sentinel-zoom-controls">
                  <button
                    onClick={() => setZoom(1)}
                    className="sentinel-zoom__fit-btn"
                    title="화면에 맞추기"
                  ...
                  <div className="sentinel-zoom__divider" />
                  <div className="sentinel-zoom__slider-group">
                    <Icon icon="lucide:zoom-out" className="sentinel-zoom__icon" />
                    <input
                      type="range"
                      min="0.1"
                      max="5"
                      ...
                      className="sentinel-zoom__range"
                    />
                    <Icon icon="lucide:zoom-in" className="sentinel-zoom__icon" />
                  </div>
                  <div className="sentinel-zoom__percent">
                    {Math.round(zoom * 100)}%
                  </div>
                  </div>
                </>
              ...
              <div
                ...
                className={`sentinel-canvas ${
                  !image
                    ? "sentinel-canvas--empty"
                    : "sentinel-canvas--loaded"
                }`}
                style={
                  image
              ...
              >
                <input
                  ...
                  accept="image/*"
                  className="sentinel-file-input"
                />

                {!image ? (
                  <div className="sentinel-upload">
                    <div className="sentinel-upload__icon-wrap">
                      <Icon icon="lucide:upload" className="sentinel-upload__icon" />
                    </div>
                    <p className="sentinel-upload__title">
                      여기에 장비 이미지를 드래그 앤 드롭하세요
                    </p>
                    <p className="sentinel-upload__subtitle">
                      PNG, JPG, WEBP 지원
                    </p>
                  </div>
                ) : (
                  <div
                    className="sentinel-image-wrapper"
                    style={{
                      width: `${zoom * 100}%`,
                      minWidth: `${zoom * 100}%`,
                    }}
                  ...
                  >
                    ...
                    <div className="sentinel-image-glow"></div>

                    {selectionBox && (
                      <div
                        className="sentinel-selection-box"
                        style={{
                    ...
                    {editMode &&
                      ...
                      (() => {
                        ...
                        return (
                          <div
                            className="sentinel-multiselect"
                            style={{
                              left: `${left}px`,
                              top: `${top}px`,
                              width: `${width}px`,
                          ...
                          >
                            <motion.div
                              ...
                              className="sentinel-multiselect__popup"
                              style={{
                            ...
                            >
                              {/* Alignment Section */}
                              <div className="sentinel-align">
                                <div className="sentinel-align__group">
                                  <button
                                    onClick={() => alignSelected("top")}
                                    className="sentinel-align__btn"
                                    title="상단 정렬"
                                  >
                                ...
                                <div className="sentinel-align__divider" />
                                <div className="sentinel-align__group">
                                  <button
                              ...
                              <div className="sentinel-multiselect__section-divider" />

                              {/* Properties Section */}
                              <div className="sentinel-props">
                                <div className="sentinel-props__field">
                                  <span className="sentinel-props__label">
                                    이름
                                  </span>
                                  <input
                                    type="text"
                                    ...
                                    className="sentinel-props__input"
                                  />
                                </div>
                                {(() => {
                                  const vHeight =
                                  ...
                                  return (
                                    <div className="sentinel-dims">
                                      <div className="sentinel-dims__col">
                                        <span className="sentinel-dims__label">
                                          가로
                                        </span>
                                        <div className="sentinel-dims__stepper">
                                          <button
                                            onClick={(e) => {
                                              e.stopPropagation();
                                              saveHistory();
                                            ...
                                            className="sentinel-dims__step-btn"
                                          >
                                            -
                                          </button>
                                          <input
                                            ...
                                            className="sentinel-dims__step-input no-spinners"
                                          />
                                          <button
                                            onClick={(e) => {
                                              e.stopPropagation();
                              ...
                              <div className="sentinel-actions">
                                <div className="sentinel-actions__col">
                                  <button
                                    onClick={duplicateGroupSelected}
                                    className="sentinel-actions__grp-btn"
                                  >
                                    <Icon icon="lucide:grid" />
                                    GRP_CPY
                                  </button>
                                  <button
                                    ...
                                    className="sentinel-actions__itr-btn"
                                  >
                                ...
                                <div className="sentinel-actions__count-col">
                                  <span className="sentinel-actions__count">
                                    {selectedIndices.length}
                                  </span>
                                  <button
                                    onClick={() => setSelectedIndices([])}
                                    className="sentinel-actions__clear-btn"
                                    title="선택 해제"
                                  >
                                    <Icon icon="lucide:x" />
                                  </button>
            ...
            <div className="sentinel-telemetry">
              <h2 className="sentinel-telemetry__title">
                장비 분석 결과
              </h2>

              {!image ? (
                <div className="sentinel-telemetry__empty">
                  <Icon icon="lucide:layout-grid" className="sentinel-telemetry__empty-icon" />
                  <span className="sentinel-telemetry__empty-text">
                    이미지가 없습니다
                  </span>
                  <span className="sentinel-telemetry__empty-sub">
                    장비 이미지를 업로드하여 분석을 시작하세요
                  </span>
                </div>
              ) : !ports.length && !loading ? (
                <div className="sentinel-analyze-wrap">
                  <button
                    onClick={analyzeImage}
                    className="sentinel-analyze-btn"
                  >
                    <div className="sentinel-analyze-btn__shimmer"></div>
                    <div className="sentinel-analyze-btn__content">
                      <Icon icon="lucide:send" className="sentinel-analyze-btn__icon" />
                      <span className="sentinel-analyze-btn__text">
                        AI 분석 시작
                      </span>
                    </div>
                  </button>
                  <span className="sentinel-analyze-subtitle">
                    Gemini AI를 사용하여 하드웨어 포트를 자동 감지합니다
                  </span>

                  {error && (
                    <div className="sentinel-error">
                      <Icon icon="lucide:alert-circle" className="sentinel-error__icon" />
                      <div
                        className="sentinel-error__text"
                        title={error}
                      >
                        {error}
                      </div>
                      <button
                        onClick={analyzeImage}
                        className="sentinel-error__retry"
                      >
                        재시도
                      </button>
                    </div>
                ...
                <div className="sentinel-results">
                  {loading ? (
                    <div className="sentinel-loading">
                      <div
                        ref={logsContainerRef}
                        className="sentinel-loading__logs sentinel-scrollbar"
                      >
                        {loadingLogs.map((log, idx) => (
                          <div key={idx} className="sentinel-log-entry">
                            <div className="sentinel-log-entry__dot" />
                            <span className="sentinel-log-entry__text">
                              {log}
                            </span>
                            {idx < loadingLogs.length - 1 && (
                              <span className="sentinel-log-entry__ok">
                                [ OK ]
                              </span>
                            )}
                          </div>
                      ...
                      <div className="sentinel-progress">
                        <div className="sentinel-progress__labels">
                          <span className="sentinel-progress__label">
                            분석 진행률
                          </span>
                          <span className="sentinel-progress__value">
                            {Math.round(loadingStep)}%
                          </span>
                        </div>
                        <div className="sentinel-progress__track">
                          <div
                            className="sentinel-progress__bar"
                            style={{
                    ...
                    <div className="sentinel-analysis-text">
                      <span>
          ...
          <section className="sentinel-sidebar-section">
            <div className="sentinel-registry">
              <div className="sentinel-registry__header">
                <div className="sentinel-registry__header-left">
                  <div className="sentinel-registry__dot"></div>
                  <h3 className="sentinel-registry__title">
                    포트 목록
                  </h3>
                </div>
                {ports.length > 0 && (
                  <button
                    ...
                    className="sentinel-registry__collapse-btn"
                  >
                    {collapsedCategories.size >=
                    new Set(ports.map((p) => p.portName || "UNNAMED")).size ? (
                      <Icon icon="lucide:chevron-right" className="sentinel-registry__collapse-icon" />
                    ) : (
                      <Icon icon="lucide:chevron-down" className="sentinel-registry__collapse-icon" />
                    )}
                  </button>
                )}
              </div>

              <div className="sentinel-registry__list sentinel-scrollbar">
                {ports.length > 0 ? (
                  <div className="sentinel-registry__groups">
                    {/* Grouping by name */}
                    {Object.entries(
                      ports.reduce(
                      ...
                      return (
                        <div key={category} className="sentinel-category">
                          <div
                            className="sentinel-category__header"
                            onClick={() => toggleCategory(category)}
                          >
                            <div className="sentinel-category__header-left">
                              {isCollapsed ? (
                                <Icon icon="lucide:chevron-right" className="sentinel-category__chevron" />
                              ) : (
                                <Icon icon="lucide:chevron-down" className="sentinel-category__chevron" />
                              )}
                              <span className="sentinel-category__name">
                                {category}
                              </span>
                            </div>
                            <span className="sentinel-category__count">
                              {items.length} units
                            </span>
                          </div>

                          {!isCollapsed && (
                            <div className="sentinel-category__items">
                              {items.map(({ port, originalIdx }) => (
                                <div
                                  key={`reg-${originalIdx}`}
                                  className={`sentinel-reg-item ${
                                    activePort === originalIdx ||
                                    selectedIndices.includes(originalIdx)
                                      ? "sentinel-reg-item--active"
                                      : ""
                                  }`}
                                  onMouseEnter={() =>
                                ...
                                >
                                  <div className="sentinel-reg-item__content">
                                    <div
                                      className="sentinel-reg-item__badge"
                                    >
                                      {port.portNumber}
                                    </div>
                                    <div className="sentinel-reg-item__details">
                                      <span className="sentinel-reg-item__name">
                                        {port.portName || "UNNAMED"}
                                      </span>
                                      <div className="sentinel-reg-item__coords">
                                        <span className="sentinel-reg-item__coord">
                                  ...
                                  <div className="sentinel-reg-item__actions"></div>
                                </div>
                              ))}
                            </div>
                          )}
                  ...
                  <div className="sentinel-registry__empty">
                    <Icon icon="lucide:grid" className="sentinel-registry__empty-icon" />
                    <div className="sentinel-registry__empty-texts">
                      <p className="sentinel-registry__empty-title">
                        Null Vector Array
                      </p>
                      <p className="sentinel-registry__empty-sub">
      ...
      <footer className="sentinel-footer">
        <div className="sentinel-footer__cols">
          <div>
            <p className="sentinel-footer__label">
              Neural Core
            </p>
            <p className="sentinel-footer__value">
        ...
        <div className="sentinel-footer__right">
          <p className="sentinel-footer__company">
            포트맵핑 마법사 <Icon icon="mdi:magic" className="comm-icon-magic-sm" /> Systems
          </p>
          <p className="sentinel-footer__copyright">
      ...
      <AnimatePresence>
        {showDownloadModal && (
          ...
          >
            ...
            >
              <div className="sentinel-modal__gradient"></div>

              <div className="sentinel-modal__header">
                <div>
                  <h2 className="sentinel-modal__title">
                    맵 내보내기
                  </h2>
                  <p className="sentinel-modal__subtitle">
                    벡터 SVG 생성
                  </p>
                </div>
                <button
                  onClick={() => setShowDownloadModal(false)}
                  className="sentinel-modal__close-btn"
                >
                  <Icon icon="lucide:x" />
                </button>
              </div>

              <div className="sentinel-modal__body">
                <div>
                  <label className="sentinel-modal__label">
                    파일 이름 지정
                  </label>
                  <div className="sentinel-modal__input-wrap">
                    <input
                      type="text"
                      ...
                      className="sentinel-modal__input"
                      placeholder="hardware-ports"
                      autoFocus
                    />
                    <span className="sentinel-modal__input-suffix">
                      .svg
                    </span>
                  </div>
                </div>

                <div className="sentinel-modal__actions">
                  <button
                    onClick={() => setShowDownloadModal(false)}
                    className="sentinel-modal__cancel-btn"
                  >
                    취소
                  </button>
                  <button
                    onClick={executeDownload}
                    className="sentinel-modal__submit-btn"
                  >
                    <Icon icon="lucide:download" />
                    내보내기 실행
                  </button>
