...
export const ImageCropper = forwardRef<ImageCropperRef, ImageCropperProps>(({
  ...
  return (
    <div className="wizard-cropper__image-container" ref={containerRef} style={{position: "relative", width: "100%", height: "100%"}}>
          <img 
            ref={imageRef} 
            src={imageSrc} 
            alt="To crop" 
          ...
          <svg className="wizard-cropper__svg" viewBox="0 0 100 100" preserveAspectRatio="none" style={{ position: "absolute", top: 0, left: 0, width: "100%", height: "100%", pointerEvents: "none", zIndex: 2 }}>
            <polygon 
          ...
          {points.map((p, i) => (
            <div
              key={i}
              className="wizard-cropper__handle"
          ...
          {showMagnifier && (
            <div 
              className="wizard-cropper__magnifier"
              style={{
